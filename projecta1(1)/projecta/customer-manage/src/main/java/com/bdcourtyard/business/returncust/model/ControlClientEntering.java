package com.bdcourtyard.business.returncust.model;
...
public class ControlClientEntering implements Serializable {
	...
	private List<String> needReturnTimeList;
	...
	public List<String> getNeedReturnTimeList() {
		return needReturnTimeList;
	}

	public void setNeedReturnTimeList(List<String> needReturnTimeList) {
		this.needReturnTimeList = needReturnTimeList;
	}
}
