package com.bdcourtyard.business.housetype.util;
...
//    private static final String EMAIL = "^([0-9A-Za-z\\-_\\.]+)@([0-9a-z]+\\.[a-z]{2,3}(\\.[a-z]{2})?)$";
     ...
     */
    public static boolean validateHW(Double num){
        if(num<=THREEHUNDRED && num>ZERO){
            return Validate.isPrice(num.toString());
        }
        return false;
    }
